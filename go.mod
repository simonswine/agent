...
require (
	...
	github.com/simonswine/grafana-agent-cnc v0.0.0-20240131170537-5d61a5ebfbfd
...
require (
	...
	github.com/simonswine/prometheus-labels v0.0.0-20210820132351-154f8d10c045 // indirect
